  ...
  return (
    <Card mb={6}>
      <CardContent>
        ...
        <Button mr={2} mb={2} variant="contained">
          Default
        </Button>
        <Button mr={2} mb={2} variant="contained" color="primary">
          Primary
        </Button>
        <Button mr={2} mb={2} variant="contained" color="secondary">
          Secondary
        </Button>
        <Button mr={2} mb={2} variant="contained" color="success">
          Success
        </Button>
        <Button mr={2} mb={2} variant="contained" color="warning">
          Warning
        </Button>
        <Button mr={2} mb={2} variant="contained" color="error">
          Error
        </Button>
        <Button mr={2} mb={2} variant="contained" color="info">
          Info
        </Button>
        <Button mr={2} mb={2} variant="contained" color="secondary" disabled>
          Disabled
        </Button>
      </CardContent>
    </Card>
