...
import SmartDetect from "./pages/smart-detect";
import Alerts from "./pages/alerts";
import IncidentManagement from "./pages/incident-management";
import RoleManagement from "./pages/setup/Role Management";
import UserManagement from "./pages/setup/User Management";
import DataSourceManagement from "./pages/setup/Data Source Management";
import DatabaseManagement from "./pages/setup/Database Management";
import WorkflowDefinition from "./pages/setup/Workflow Definition";
import Configurator from "./pages/setup/Configurator";
import SLASchedules from "./pages/setup/SLA & Schedules";
import Messaging from "./pages/setup/Messaging";
